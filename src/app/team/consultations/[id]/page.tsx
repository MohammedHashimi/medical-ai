...
export default async function TeamConsultationPage({
  params,
}: PageProps) {
  ...
  if (!response.ok) {
    console.error(
      "Backend consultation request failed:",
      response.status,
      responseText
    );
  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="mx-auto max-w-6xl px-5 py-8">
        ...
        {/* Red flags */}
        <section className="mt-8 rounded-2xl border border-red-200 bg-white p-5 shadow-sm">
          <p className="text-sm text-red-500">
            Safety assessment
          </p>

          <h2 className="mt-1 text-xl font-semibold text-red-700">
            Red flags
          </h2>
